...
- Reconciled step07 termination criteria across SKILL.md, `step07-review-dossier.md`, and `research-reviewing.md` (single source of truth)

## v1.0 (initial release)
- Eight-step workflow: clarify scope -> MoA landscape -> compound landscape -> endpoint framework -> study designs -> synthesis -> delegated review -> delivery
...
- delegated review via delegated reviewer with state persistence and self-review fallback (step07)
